...
\begin{figure}[!htb]
  \centering
  \includegraphics[scale=.3]{file_read_times_remote.png}
  \caption{Left x-axis is the size of file and y-axis is average read time per block. Both are on log scale.}
...
\begin{table}[!htbp]
  ...
  \begin{tabular}{|l|l|l|l|l|l|}
    ...
    Remote Sequential Read Time     & 200000 ns           & 5 ns       & 202000 ns           & 587094 ns                                                                  \\ \hline
    Remote Random Read Time     & 3000000 ns           & 5 ns       & 30000005 ns            & 58943456 ns                                                                  \\ \hline
